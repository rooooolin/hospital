<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyCase.aspx.cs" Inherits="hospital.Case.ModifyCase" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <asp:DropDownList ID="AffDoc" style="width:22%; height:35px; border:1px solid #ccc;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="AffDoc_SelectedIndexChanged"></asp:DropDownList>
        ...
        <asp:Label ID="FileLabel" runat="server" Text="" Style="color: Red"></asp:Label> 
            ...
            <div class="controls">
                <asp:Button ID="ModifyBtn" runat="server" class="btn btn-success" Text="修改" style="width:120px;" OnClick="ModifyBtn_Click" /></div>
        </div>
    </div>
    </form>
</body>
